...
class CSVReader {
	 ...
	 * 
	 * @param csv
	 *            - 2nd-dimensional CSV {@link String} Array.
	 * @return {@link StitchColor} Array.
	 * @throws NoSuchElementException
	 *             occurs when one or more of R, G, or B values is missing.
	 * @throws NumberFormatException
	 *             occurs when one or more of R, G, or B values can not be read.
	 * @throws IllegalArgumentException
	 *             occurs when one or more of the R, G, or B values is not a value
	 *             between 0 and 255.
	 */
